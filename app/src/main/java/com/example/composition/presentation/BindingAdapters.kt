...
fun bindingRequireAdapter(textView: TextView, count: Int) {
...
fun bindingScoreAdapter(textView: TextView, count: Int) {
    textView.text = String.format(
...
fun bindingEnoughCountOfRightAnswer(textView: TextView, enough: Boolean){
    textView.setTextColor(getColorByState(textView.context, enough))
}

@BindingAdapter("enoughPercentOfRightAnswer")
fun bindingEnoughPercentOfRightAnswer(progressBar: ProgressBar, enough: Boolean ){
